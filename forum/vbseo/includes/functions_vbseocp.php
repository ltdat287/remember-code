...
5 => self::lang('copyright_sel_5'),
6 => self::lang('copyright_sel_6'),
7 => self::lang('copyright_sel_7'),
8 => self::lang('copyright_sel_8'),
9 => self::lang('copyright_sel_9'),
...
/*
array('forum_feeds_url_forum', 'VBSEO_URL_FORUM_TITLE_FEED', array(
'rss-[forum_title].xml',
'feed-[forum_title].rss',
'rss-[forum_id].xml',
'feed-[forum_id].rss',
)),
*/
...
case 'stopwords':
$ttlitem = 'seo_func';
$o1 = vBSEO_Storage::setting('VBSEO_KEEP_STOPWORDS');
...
$bm .= self::display_option_cb_field('VBSEO_BOOKMARK_FURL', '<a rel="bookmark" href="http://furl.net" target="_blank">furl.net</a>');
...
$opts .= self::display_option_select('blog_bookm_desc', 'VBSEO_BOOKMARK_BLOG', 
array(
0 => self::lang('blogbmark_none'),
1 => self::lang('blogbmark_topright'),
2 => self::lang('blogbmark_bottom'),
));
break;
case 'img_size':
$ttlitem = 'oth_enh';
...
$presetmatch = self::get_preset_match($presets, $ftype);
...
if(self::$logged_in)
{
$fmsg = self::check_legacy_files(self::$legacy_files);
if($fmsg)
$result['messages'][] = array('attention', $fmsg);
$fmsg = self::check_empty_formats();
if($fmsg)
$result['messages'][] = array('attention', $fmsg);
}
return $result;
