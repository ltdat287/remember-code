...
{
$seo_preg_replace['#(<(?:[^sa]|sp)[^<]*>)([^<]*?)\b(' . $sk . ')\b([^<]*)#sei'] = 
...
array_unshift($vbseo_bmlist, array('http://www.furl.net/storeIt.jsp?u=%url%&amp;t=%title%', vBSEO_Storage::path('fimages').'furl.gif', $vbphrase['vbseo_add_to_furl'], $vbphrase['vbseo_add_to_furl_post'], $vbphrase['vbseo_add_to_furl_blog']));
