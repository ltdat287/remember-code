...
define('VBSEO_VERSION2_MORE', '3.5.0 RC2');
...
$vbseo_req = preg_replace('#vbseo\.php.*#', $_GET['vbseourl'] . ($_SERVER['QUERY_STRING']?'?'.preg_replace('#(vbseourl|vbseorelpath)=[^&]*#', '', $_SERVER['QUERY_STRING']):''), $vbseo_req);
