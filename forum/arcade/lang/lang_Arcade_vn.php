...
$lang = array (
arcade_announcements	=> "Thông Báo:",
page_title    		=> 'Arcade',
arcade_offline		=> "! ARCADE OFFLINE !",
logged_as	  	=> 'Ðãng nh?p dý?i tên',
newest_games		=> 'Game m?i nh?t',
arcade_cp_link		=> 'Qu?n l?',
welcome	  		=> 'Chào m?ng b?n ð?n v?i tr? chõi-Sinhviennamdinh.net',
news_events	  	=> 'Tin t?c và s? ki?n',
you_think     		=> 'B?n có ph?i là nhà vô ð?ch,chõi ngay ð? bi?t!',
help_text  	  	=> "Xin chào",
choose_file	  	=> "L?a ch?n tr? chõi",
joined       	 	=> "Gia  nh?p:",
posts         		=> "Bài vi?t:",
group         		=> "Nhóm:",
arcade_home   		=> "Trang c??",
arcade_scores 		=> "Ði?m cao",
today			=> "Hôm nay",
yesterday		=> "Hôm qua",
report_for		=> " B?ng x?p h?ng ",
your_report		=> "X?p h?ng c?a tôi",
grand_champions		=> "Nhà vô ð?ch",
arcade_champ		=> "Champion-Sinh Viên Nam Ð?nh",
cat_champ		=> "Thý m?c-Champion",
new_champ		=> "<% USERNAME %> is the new <% GAMENAME %> champion!",
search			=> "T?m ki?m",
arcade_stats		=> "Th?ng kê",
newest_champs		=> "m?i nh?t Champions&nbsp;",
latest_score		=> "Cu?i cùng Arcade Score&nbsp;",
your_favs		=> "yêu thích c?a b?n",
details			=> "Chi ti?t ngý?i chõi ",
sort_em			=> "Sort",
asc			=> "Tãng d?n",
choose_cat		=> "ch?n thý m?c",
time_played		=> "Th?i gian chõi: ",
time_played_p		=> "Th?i gian chõi",
league			=> "Ngôn ng?",
leaderboard		=> "Leaderboard",
desc			=> "Gi?m d?n",
gname			=> "Tên",
times_p			=> "Th?i gian chõi",
description		=> "Mô t?",
rating_s		=> "Ðánh giá",
dateadded		=> "Date added",
cat_pass_msg		=> "Ðây là m?t kh?u b?o v?.<br />Nh?p vào m? b?o v?.",
cat_pass		=> "M?t kh?u b?o v?",
cat_pass_notice		=> "<b>Lýu ?</b>: Cookie ðý?c yêu c?u vào th?i ði?m này",
my_favs			=> "yêu thích c?a tôi",
no_favs			=> "B?n không có yêu thích l?a ch?n. B?n có th? thêm chúng b?ng cách click vào tên tr? chõi trong danh sách tr? chõi.",
no_embed		=> "Xin l?i, b?n s? c?n nh?ng<a href=\"http://www.macromedia.com/go/getflashplayer/\" target=\"_blank\">Flash Player</a> to play ",
score_beat		=> "Score to Beat:",
back_arcade		=> "Quay l?i Arcade",
view_high		=> "Xem ði?m cao",
your_high		=> "K?t qu? c?a b?n ",
times_played		=> "Th?i gian chõi Played: ",
...
score			=> "Ði?m",
rank			=> "Rank",
your_score		=> "Ði?m c?a b?n",
username		=> "Tên",
comment			=> "Tr? l?i",
time			=> "Th?i gian",
timespent		=> "Time spent",
pound			=> "#",
top_score		=> "Top ði?m cao",
play_game		=> "Play ",
champion		=> " Champion!",
game_info		=> "Thông tin game",
save_comment		=> "Lýu",
all_games		=> "T?t c? game",
add_to			=> "Thêm vào ",
remove_from		=> "Xóa kh?i ",
