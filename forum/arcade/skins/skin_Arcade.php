...
global $ibforums;
if ($stylecolumns < 1) { $stylecolumns = 1; }
$gamewidth = 100/$stylecolumns;
return <<<EOF

<td width="$gamewidth%" valign="top">
...
global $ibforums;
if (($stylecolumns == "") || ($stylecolumns < 1)) { $stylecolumns = 4; }
...
function the_cat_table($cats,$stylecolumns) {
global $ibforums;
if (($stylecolumns == "") || ($stylecolumns < 1)) { $stylecolumns = 4; }
return <<<EOF
	<tr>
...
return <<<EOF
	...
	<table width='100%' border='0' cellspacing='1' cellpadding='4'>
		<tr>
			<td width="100%" align="center" class="thead" colspan="5">{$ibforums->lang['your_score']}</td>
		</tr>
		<tr>
			<td width="30%" align="center" class="tcat">{$ibforums->lang['username']}</td>
			<td width="10%" align="center" class="tcat">{$ibforums->lang['score']}</td>
		...
		<tr>
			<td width="30%" align="center" class="alt1">{$yscore['1']}</td>
			<td width="10%" align="center" class="alt1">{$yscore['2']}</td>
			<td width="45%" align="center" class="alt1">{$commentcell}</td>
			<td width="15%" align="center" class="alt1">{$yscore['3']}</td>
			<td width="15%" align="center" class="alt1">{$yscore['6']}</td>
		</tr>
	</table>
	</div>
	<br />
...
return <<<EOF
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="4">
		<tr>
			<td width="100%" align="left" class="thead" colspan="2">&nbsp;&nbsp;&nbsp;{$ibforums->lang['game']}</td>
		</tr>
		<tr>
			...
			<table width="100%">
				<tr>
					<td valign="top" align="center" width="7%">
						&nbsp;&nbsp;&nbsp;{$links['imglink']}<img src="./arcade/images/{$ginfo['gname']}1.gif" alt="" align="top" border="0" width="50" height="50" />{$links['imgend']}
                    </td>
					...
					<td width="25%" align="center" valign="top">
						<fieldset class="fieldset" style="margin: 0px 0px 0px 0px;">
							<legend>{$ibforums->lang['options']}&nbsp;</legend>
							<div style="padding: 0px;">
							<table cellpadding="0" cellspacing="0" border="0" align="center" width="100%">
								<tr>
									<td width="100%">
	...
	<table width='100%' border='0' cellspacing='1' cellpadding='4'>
	<tr>
		<td width="100%" align="center" class="thead" colspan="6">{$ibforums->lang['hscores_title']}</td>
	</tr>
    <tr>
  			...
  			<td valign="top" align="left" width="25%">
            	<div class="tborder">
  				<table width="100%" border="0" cellspacing="1" cellpadding="4">
					...
					<tr>
                    	<td align="center" class="alt1">{$top['playertext']}<br /><b>{$top['name']}</b></td>
                    </tr>
					<tr>
...
return <<<EOF
	...
	<table border="0" cellpadding="3" cellspacing="1" width="100%">
    	<tr>
        	<td class="alt1" align="center">{$ibforums->lang['current_version']}<b>{$version}</b></td>
        </tr>
    </table>
    </div><br />
	<div class="tborder">
	<table border="0" cellpadding="3" cellspacing="1" width="100%">
        ...
        <tr>
        	<td align="center" class="alt1">{$ibforums->lang['game']}</td>
            <td align="center" class="alt1">{$ibforums->lang['username']}</td>
            <td align="center" class="alt1">{$ibforums->lang['score']}</td>
            <td align="center" class="alt1">{$ibforums->lang['time']}</td>
            {$remove}
        </tr>
        {$scores}
    </table>
	...
	<table border="0" cellpadding="3" cellspacing="1" width="100%">
        ...
        <tr>
        	<td align="center" class="alt1">{$ibforums->lang['game']}</td>
        	<td align="center" class="alt1">{$ibforums->lang['username']}</td>
            <td align="center" class="alt1">{$ibforums->lang['comment']}</td>
            <td align="center" class="alt1">{$ibforums->lang['time']}</td>
            {$edit}
        </tr>
        {$comments}
...
return <<<EOF
	...
	<table border="0" cellpadding="3" cellspacing="1" width="100%">
        ...
        <tr>
            ...
            <td align="center" class="alt1">{$ibforums->lang['comment']}</td>
            <td align="center" class="alt1">{$ibforums->lang['time']}</td>
            <td align="center" class="alt1">{$ibforums->lang['edit_comment']}</td>
        </tr>
        {$comments}
    </table>
    </div>
...
return <<<EOF
	...
	<div align="center">
	<div class="tborder" align="left" style="width: 100%;">
    <table width="100%" border="0" cellpading="3" cellspacing="1" class="alt1">
    	<tr>
        	<td class="thead" colspan="2">{$ibforums->lang['your_settings']}</td>
        </tr>
        <tr>
        	<td style="width: 60%;">{$ibforums->lang['sorting_def']}</td>
...
return <<<EOF
	<tr>
    	<td width="60%" align="right" class="{$rowcol}">{$title}</td>
        <td width="40%" align="left" class="{$rowcol}">{$detail}</td>
    </tr>
EOF;
}
...
return <<<EOF
	<tr>
    	<td class="alt1" align="center"><span style="font-weight: bold; font-size: 10pt;">{$ibforums->lang['no_favs']}</td>
    </tr>
EOF;
}
...
return <<<EOF
    ...
    <br />
    <div class="tborder">
    <table cellspacing="1" cellpadding="3" width="100%" border="0" class="alt1">
    	<tr>
        	<td class="alt1" colspan="2">
...
return <<<EOF
    ...
    <table border="0" width="100%" cellpadding="3" cellspacing="1">
        ...
        <tr>
        	<td class="alt1" colspan="2">{$ibforums->lang['enter_user_id']}</td>
        </tr>
        {$rows}
        <tr>
        	<td class="pformstrip" colspan="2" align="center">
...
return <<<EOF
    ...
    <table border="0" width="100%" cellpadding="3" cellspacing="1">
        ...
        <tr>
        	<td class="alt1">{$ibforums->lang['confirm_users']}</td>
        </tr>
        {$users}
        <tr>
...
return <<<EOF
    ...
    <table cellspacing="1" cellpadding="3" border="0" width="100%">
        ...
        <tr>
        	<td class="alt1">{$ibforums->lang['make_sure']}</td>
        </tr>
        <tr>
