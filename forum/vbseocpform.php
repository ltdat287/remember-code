...
'groups/[group_name]-[discussion_id]-[discussion_title].html',
'groups/[group_id]-[discussion_id].html',
'groups/[group_id]-[group_name]-[discussion_id]-[discussion_title].html',
...
'groups/[group_name]-[discussion_id]-[discussion_title]-page[page].html',
'groups/[group_id]-[discussion_id]-page[page].html',
'groups/[group_id]-[group_name]-[discussion_id]-[discussion_title]-page[page].html',
...
'groups/[group_name]-[discussion_id]-[discussion_title]-last-post.html',
'groups/[group_id]-[discussion_id]-last-post.html',
'groups/[group_id]-[group_name]-[discussion_id]-[discussion_title]-last-post.html',
...
'groups/category[cat-id]-[cat_name].html',
...
'groups/category[cat-id]-[cat_name]-page[page].html',
...
<td><input name=virthtml type=radio value=1 <?php echo VBSEO_VIRTUAL_HTML?'CHECKED ':''?>>
<?php echo $alang['yes']?>
<input type=radio value=0  <?php echo VBSEO_VIRTUAL_HTML?'':'CHECKED '?>
name=virthtml>
<?php echo $alang['no']?> </td>
</tr>
<tr align="right" class=header>
