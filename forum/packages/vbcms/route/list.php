 ...
 * @version $Revision: 33887 $
 * @since $Date: 2009-11-29 23:39:23 -0600 (Sun, 29 Nov 2009) $
...
class vBCms_Route_List extends vB_Route
{
	...
	*/
	...
	public function getResponse()
	{
		...
		$controller = new vbCms_Controller_List(array($this->type, $this->value, $this->page));
		return $controller->actionList($correct_route, array($this->type, $list_value, $this->page));
	}
