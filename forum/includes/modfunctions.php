...
function show_inline_mod_login()
{
	...
	//flag to STANDARD_ERROR that this is going to be a form.
	$show['error_form'] = true;
	$templater = vB_Template::create('threadadmin_authenticate');
		$templater->register('formvars', $formvars);
