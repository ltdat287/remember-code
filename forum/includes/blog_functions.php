...
function &build_overview_sidebar($month = 0, $year = 0)
{
	...
	$ad_location['ad_blog_sidebar_start'] = vB_Template::create('ad_blog_sidebar_start')->render();
	$ad_location['ad_blog_sidebar_middle'] = vB_Template::create('ad_blog_sidebar_middle')->render();
	$ad_location['ad_blog_sidebar_end'] = vB_Template::create('ad_blog_sidebar_end')->render();
			...
			(
				...
				(
					...
					$entryinfo['permissions']['vbblog_entry_permissions'] & $vbulletin->bf_ugp_vbblog_entry_permissions['blog_candeleteentry']
						AND
					(
						$vbulletin->userinfo['userid'] == $entryinfo['userid']
							OR
						(
							(
...
function construct_blog_rules($area = 'entry', $userinfo = null)
{
	...
	$templater = vB_Template::create('blog_rules');
		$templater->register('bbcodeoon', $bbcodeon);
