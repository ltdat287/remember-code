...
function get_adsense_templates()
{
	...
	$ad_navbar_below_low_text = '<vb:if condition="$GLOBALS[\'vbulletin\']->adsense_pub_id AND CONTENT_PAGE">
...
<script type="text/javascript"
  src="http://pagead2.googlesyndication.com/pagead/show_ads.js">
	...
	$ad_footer_start_low_text = '<vb:if condition="$GLOBALS[\'vbulletin\']->adsense_pub_id AND CONTENT_PAGE">
...
<script type="text/javascript"
  src="http://pagead2.googlesyndication.com/pagead/show_ads.js">
	...
	$ad_footer_start_high_text = '<vb:if condition="$GLOBALS[\'vbulletin\']->adsense_pub_id AND CONTENT_PAGE">
...
<script type="text/javascript"
  src="http://pagead2.googlesyndication.com/pagead/show_ads.js">
	...
	$ad_navbar_below_high_text = '<vb:if condition="$GLOBALS[\'vbulletin\']->adsense_pub_id AND CONTENT_PAGE">
<div style="width:728px; margin:0 auto; padding-bottom:1em">
<script type="text/javascript"><!--
google_ad_client = "{$GLOBALS[\'vbulletin\']->adsense_pub_id}";
google_ad_host = "{$GLOBALS[\'vbulletin\']->adsense_host_id}";
...
<script type="text/javascript"
  src="http://pagead2.googlesyndication.com/pagead/show_ads.js">
	...
	$ad_showthread_firstpost_start_high_text = '<vb:if condition="$GLOBALS[\'vbulletin\']->adsense_pub_id AND CONTENT_PAGE">
...
<script type="text/javascript"
  src="http://pagead2.googlesyndication.com/pagead/show_ads.js">
	...
	$ad_showthread_firstpost_sig = '<vb:if condition="$GLOBALS[\'vbulletin\']->adsense_pub_id AND CONTENT_PAGE">
<vb:if condition="!$bbuserinfo[\'userid\']">
