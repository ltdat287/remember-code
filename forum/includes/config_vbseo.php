...
'VBSEO_URL_BLOG_GLOB_CAT' => 'blogs/categories/([a-z\._\-ŠŽšžŸÀÁÂÃÄÅÇÈÉÊËÌÍÎÏÑÒÓÔÕÖØÙÚÛÜÝàáâãäåçèéêëìíîïñòóôõöøùúûüýÿµA-Z\d-]+)/',
'VBSEO_URL_BLOG_GLOB_CAT_PAGE' => 'blogs/categories/([a-z\._\-ŠŽšžŸÀÁÂÃÄÅÇÈÉÊËÌÍÎÏÑÒÓÔÕÖØÙÚÛÜÝàáâãäåçèéêëìíîïñòóôõöøùúûüýÿµA-Z\d-]+)/index(\d+)\.html',
...
'VBSEO_URL_BLOG_CUSTOM' => 'blogs/([^/]+)/custom(\d+)-([a-z\._\-ŠŽšžŸÀÁÂÃÄÅÇÈÉÊËÌÍÎÏÑÒÓÔÕÖØÙÚÛÜÝàáâãäåçèéêëìíîïñòóôõöøùúûüýÿµA-Z\d-]+)\.html',
...
'VBSEO_URL_GROUPS_CATEGORY' => 'groups/category-([a-z\._\-ŠŽšžŸÀÁÂÃÄÅÇÈÉÊËÌÍÎÏÑÒÓÔÕÖØÙÚÛÜÝàáâãäåçèéêëìíîïñòóôõöøùúûüýÿµA-Z\d-]+)\.html',
'VBSEO_URL_GROUPS_CATEGORY_PAGE' => 'groups/category-([a-z\._\-ŠŽšžŸÀÁÂÃÄÅÇÈÉÊËÌÍÎÏÑÒÓÔÕÖØÙÚÛÜÝàáâãäåçèéêëìíîïñòóôõöøùúûüýÿµA-Z\d-]+)-page(\d+)\.html',
'VBSEO_URL_GROUPS_CATEGORY_LIST' => 'groups/categories\.html',
'VBSEO_URL_GROUPS_CATEGORY_LIST_PAGE' => 'groups/categories-page(\d+)\.html',
'VBSEO_URL_GROUPS_DISCUSSION' => 'groups/([^/]+)-(\d+)-([a-z\._\-ŠŽšžŸÀÁÂÃÄÅÇÈÉÊËÌÍÎÏÑÒÓÔÕÖØÙÚÛÜÝàáâãäåçèéêëìíîïñòóôõöøùúûüýÿµA-Z\d-]+)\.html',
'VBSEO_URL_GROUPS_DISCUSSION_PAGE' => 'groups/([^/]+)-(\d+)-([a-z\._\-ŠŽšžŸÀÁÂÃÄÅÇÈÉÊËÌÍÎÏÑÒÓÔÕÖØÙÚÛÜÝàáâãäåçèéêëìíîïñòóôõöøùúûüýÿµA-Z\d-]+)-page(\d+)\.html',
'VBSEO_URL_GROUPS_DISCUSSION_LAST_POST' => 'groups/([^/]+)-(\d+)-([a-z\._\-ŠŽšžŸÀÁÂÃÄÅÇÈÉÊËÌÍÎÏÑÒÓÔÕÖØÙÚÛÜÝàáâãäåçèéêëìíîïñòóôõöøùúûüýÿµA-Z\d-]+)-last-post\.html',
...
// by default.
$vbseo_custom_char_replacement = array('Æ¡'=>'o',
'Æ '=>'o',
'Ã³'=>'o',
'Ã“'=>'o',
'Ã²'=>'o',
