...
$urls_not_match = 
($vbse_rurl != substr(VBSEO_REQURL, 0, strlen($vbse_rurl)) )
&& (
strstr(VBSEO_REQURL_FULL,VBSEO_TOPREL_FULL) ||
($vbse_rurl != substr(VBSEO_REQURL_FULL, 0, strlen($vbse_rurl))) )
&& ($vbse_rurl_deenc != substr(VBSEO_REQURL, 0, strlen($vbse_rurl_deenc)) )
&& ($vbse_rurl != substr($vbse_rurl_check , 0, strlen($vbse_rurl)) )
&& ($vbse_rurl != substr(VBSEO_TOPREL_FULL . VBSEO_REQURL, 0, strlen($vbse_rurl)) )
&&
