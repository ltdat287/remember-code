...
*
* @package	vBulletin
* @version	$Revision: 35060 $
* @date		$Date: 2010-01-21 12:06:08 -0600 (Thu, 21 Jan 2010) $
*/
class vB_Database
{
	/**
...
class vB_Input_Cleaner
{
	...
	*/
	...
	function fetch_basepath($rel_modifier = false)
	{
		...
		return $this->registry->basepath = VB_URL_BASE_PATH . ($rel_modifier ? $this->xss_clean($rel_modifier) : '');
	}
