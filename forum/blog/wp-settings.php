...
if ( version_compare( '4.3', phpversion(), '>' ) ) {
	die( sprintf( /*WP_I18N_OLD_PHP*/'Máy chủ của bạn đang sử dụng phiên bản PHP %s nhưng WordPress yêu cầu phiên bản 4.3 trở lên.'/*/WP_I18N_OLD_PHP*/, phpversion() ) );
}
...
if ( !extension_loaded('mysql') && !file_exists(WP_CONTENT_DIR . '/db.php') )
	die( /*WP_I18N_OLD_MYSQL*/'PHP của bạn không có phần mở rộng cho MySQL, WordPress chỉ sử dụng cơ sở dữ liệu MySQL.'/*/WP_I18N_OLD_MYSQL*/ );
...
if ( is_wp_error($prefix) )
	wp_die(/*WP_I18N_BAD_PREFIX*/'<strong>LỖI</strong>: <code>$table_prefix</code> trong <code>wp-config.php</code> chỉ có thể bao gồm số, chữ và dấu gạch chân \'_\'.'/*/WP_I18N_BAD_PREFIX*/);
