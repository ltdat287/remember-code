...
vbseo_dleft('<b><a href="'.$pback['t_dest_url'].'" title="'.$pback['t_title'].'" target="_blank">'.(strlen($pback['t_dest_url'])>50?substr($pback['t_dest_url'],0,50).'...':$pback['t_dest_url']).'</a></b>'),
vbseo_dleft('<a href="'.$pback['t_src_url'].'" target="_blank">'.$pback['title'].'</a>'),
...
if(!$pback['title'])$pback['title']=$vbphrase['vbseo_thread_not_found'];
print_cells_row(array(
vbseo_dleft('<b><a href="'.$pback['t_dest_url'].'" target="_blank">'.$pback['title'].'</a></b>'),
vbseo_dleft('<a href="'.$pback['t_src_url'].'" title="'.$pback['t_title'].'" target="_blank">'.(strlen($pback['t_src_url'])>50?substr($pback['t_src_url'],0,50).'...':$pback['t_src_url']).'</a>'),
vbseo_dleft(date('m-d-Y',$pback['t_time']), 1),
"<nobr>
...
print_label_row('<b>' . $vbphrase['posted_by'] . '</b>', '<a href="'.$pback['t_src_url']."\" target=\"_blank\">$pback[t_src_url]</a>");
print_label_row('<b>' . $vbphrase['vbseo_for'] . '</b>', '<a href="'.$pback['t_dest_url']."\" target=\"_blank\">$pback[t_dest_url]</a>");
...
print_textarea_row($vbphrase['message'], "pingtext[$pback[t_id]]", $pback[t_text], 8, 70);
